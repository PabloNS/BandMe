...
public class MessageController {
    ...
    @GetMapping("/read/{idMessage}")
    public String readMessage(Model model, @PathVariable("idMessage") Long idMessage){
        model.addAttribute("message", messageService.readMessage(idMessage));
        return "readMessage";
    }
